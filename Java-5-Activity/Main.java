...
double mathGrade = 87.3;
double englishGrade = 96.7;
double historyGrade = 77.9;

double sumGrades = mathGrade + englishGrade + historyGrade;
System.out.println("Sum is " + sumGrades);
...
double avgGrades = sumGrades/3.0;
System.out.println("Average is "+ avgGrades);
